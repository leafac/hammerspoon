...
do
    ...
    function recording.configuration.modal:exited()
        ...
        local templateFileHandle = assert(
                                       io.open(
        ...
        for index, sceneTransition in ipairs(
            ...
            sceneTransitionItems = sceneTransitionItems .. [[
                <ITEM
                    ...
                    LENGTH ]] ..
                                       ((index <
                                           #recording.state.events
                                               .sceneTransitions and
                                           recording.state.events
                                               .sceneTransitions[index + 1]
                                               .start or
        ...
        hs.execute(
            [[mv "]] .. recording.configuration.paths.events .. [[" "]] ..
                projectDirectory .. [[/"]])
    ...
    function recording.updateEvents(updater)
        local streamingStatus = hs.execute([[npx obs-cli GetStreamingStatus]],
                                           true)
